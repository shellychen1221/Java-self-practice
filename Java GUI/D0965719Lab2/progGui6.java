...
public class progGui6 {
	...
	private JFrame frmSwqpTwoNumbers;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frmSwqpTwoNumbers.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmSwqpTwoNumbers = new JFrame();
		frmSwqpTwoNumbers.setTitle("swap two numbers");
		frmSwqpTwoNumbers.setBounds(100, 100, 450, 300);
		frmSwqpTwoNumbers.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmSwqpTwoNumbers.getContentPane().setLayout(null);
		...
		frmSwqpTwoNumbers.getContentPane().add(lblNewLabel_4);
		...
		frmSwqpTwoNumbers.getContentPane().add(lblNewLabel_4_1);
		...
		frmSwqpTwoNumbers.getContentPane().add(lblNewLabel_4_2);
		...
		frmSwqpTwoNumbers.getContentPane().add(btnNewButton);
